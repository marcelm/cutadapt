...
def setup_logging(logger, log_to_stdout=False, minimal=False, quiet=False, debug=0):
    """
    ...
    stream_handler = CrashingHandler(sys.stdout if log_to_stdout else sys.stderr)
